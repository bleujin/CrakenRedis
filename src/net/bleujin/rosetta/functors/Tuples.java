 ...
 * 
 * <p>
 * These data holders can be used to hold temporary results during parsing so
 * you don't have to create your own data types.
 * 
 * @author Ben Yu
 */
public final class Tuples {
	...
	/**
	 * Returns a {@link Pair} of 2 objects. Is equivalent to
