...
final class Keywords {
	...
	private interface StringCase {
		...
		<T> net.bleujin.rosetta.functors.Map<String, T> toMap(java.util.Map<String, T> m);
	}
	...
	private static class CaseSensitive implements StringCase {
		...
		public <T> net.bleujin.rosetta.functors.Map<String, T> toMap(java.util.Map<String, T> m) {
			return Maps.map(m);
		}
	}
	...
	private static class CaseInsensitive implements StringCase {
		...
		public <T> net.bleujin.rosetta.functors.Map<String, T> toMap(final java.util.Map<String, T> m) {
			return new net.bleujin.rosetta.functors.Map<String, T>() {
