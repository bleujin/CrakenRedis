...
import net.bleujin.rosetta.util.Strings;
...
public final class CharPredicates {
	...
	/**
	 * A {@link CharPredicate} that returns true if the character is a digit or
	 * within the range of {@code [a-f]} or {@code [A-F]}.
	 */
	...
	/**
	 * A {@link CharPredicate} that returns true if
	 * {@link Character#isUpperCase(char)} returns true.
	 */
	...
	/**
	 * A {@link CharPredicate} that returns true if
	 * {@link Character#isLowerCase(char)} returns true.
	 */
	...
	/**
	 * A {@link CharPredicate} that returns true if the character is an alpha
	 * character.
	 */
	...
	/**
	 * A {@link CharPredicate} that returns true if it is an alpha character or
	 * the underscore character {@code _}.
	 */
	...
	/**
	 * A {@link CharPredicate} that returns true if
	 * {@link Character#isLetter(char)} returns true.
	 */
	...
	/**
	 * A {@link CharPredicate} that returns true if it is an alphanumeric
	...
	/**
	 * A {@link CharPredicate} that returns true if the character is equal to
	 * {@code c}.
	 */
	...
	/**
	 * A {@link CharPredicate} that returns true if the character is not equal
	 * to {@code c}.
	 */
	...
	/**
	 * A {@link CharPredicate} that returns true if the character is within the
	 * range of {@code [a, b]}.
	 */
	...
	/**
	 * A {@link CharPredicate} that returns true if the character is not within
	 * the range of {@code [a, b]}.
	 */
	...
	/**
	 * A {@link CharPredicate} that returns true if {@code predicate} evaluates
	 * to false.
	 */
