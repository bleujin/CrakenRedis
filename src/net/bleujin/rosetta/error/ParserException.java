 ...
 *****************************************************************************/
package net.bleujin.rosetta.error;

/**
 * Is thrown when any grammar error happens or any exception is thrown during
 * parsing.
 * 
 * @author Ben Yu
 */
public class ParserException extends RuntimeException {
	 ...
	 * 
	 * @param details
	 *            the {@link ParseErrorDetails} that describes the error
	 *            details.
	 * @param moduleName
	 *            the module name.
	 * @param location
