 ...
 *****************************************************************************/
package net.bleujin.rosetta.util;
...
public final class Checks {
	 ...
	 * 
	 * @param condition
	 *            the condition that has to be true
	 * @param message
	 *            the error message if {@code condition} is false
	 * @param args
	 ...
	 * 
	 * @param condition
	 *            the condition of the state that has to be true
	 * @param message
	 *            the error message if {@code condition} is false
	 * @param args
	 *            the arguments to the error message
	...
	/**
	 * Checks that neither {@code min} or {@code max} is negative and
	 * {@code min &lt;= max}.
	 */
	...
	/**
	 * Checks that {@code n} isn't negative. Or throws an
	 * {@link IllegalArgumentException} with {@code message}.
	 */
