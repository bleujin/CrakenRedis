...
import net.bleujin.rosetta.error.Location;
import net.bleujin.rosetta.util.IntList;
...
final class DefaultSourceLocator implements SourceLocator {
	...
	private int getLineBreakColumnIndex(int lineIndex) {
		...
		return (lineIndex == 0) ? lineBreakIndex : lineBreakIndex - lineBreakIndices.get(lineIndex - 1) - 1;
	}
	 ...
	 *            the line break character.
	 */
	public DefaultSourceLocator(CharSequence source, int lineNumber, int columnNumber, char lineBreakChar) {
		this.source = source;
