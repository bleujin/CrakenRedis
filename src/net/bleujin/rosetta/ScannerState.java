...
final class ScannerState extends ParseContext {
	...
	/**
	 * @param module
	 *            the current module name for error reporting
	 * @param source
	 *            the source string
	 * @param from
	 *            from where do we start to scan?
	 * @param end
	 *            till where do we stop scanning? (exclusive)
	 * @param locator
	 *            the locator for mapping index to line and column number
