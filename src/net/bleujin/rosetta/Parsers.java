...
import net.bleujin.rosetta.error.ParserException;
import net.bleujin.rosetta.functors.Map;
import net.bleujin.rosetta.functors.Map2;
import net.bleujin.rosetta.functors.Map3;
import net.bleujin.rosetta.functors.Map4;
import net.bleujin.rosetta.functors.Map5;
import net.bleujin.rosetta.functors.Maps;
import net.bleujin.rosetta.functors.Pair;
import net.bleujin.rosetta.functors.Tuple3;
import net.bleujin.rosetta.functors.Tuple4;
import net.bleujin.rosetta.functors.Tuple5;
...
public final class Parsers {
	...
	static <T> Parser<T> infixn(final Parser<T> p, final Parser<? extends Map2<? super T, ? super T, ? extends T>> op) {
		return p.next(new Map<T, Parser<T>>() {
			public Parser<T> map(final T a) {
				final Parser<T> shift = sequence(op, p, new Map2<Map2<? super T, ? super T, ? extends T>, T, T>() {
	...
	private static <T> T applyPrefixOperators(T a, final List<? extends Map<? super T, ? extends T>> ms) {
	...
	private static <T> T applyPostfixOperators(T a, final Iterable<? extends Map<? super T, ? extends T>> ms) {
