...
public abstract class ReadSession {
	...
	public CompletableFuture<Void> tran(WriteJobNoReturn tjob) {
		return tran(new WriteJob<Void>() {
			@Override
	...
	public TemplateNode templateBy(String path) {
		...
		String templateName = StringUtil.defaultIfEmpty(StringUtil.substringAfterLast(path, "."), TemplateNode.DftTemplatePropertyName) ;
